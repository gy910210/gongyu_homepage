...
def build_resume():
    doc = SimpleDocTemplate(
        "/Users/bytedance/Documents/claude/yu-gong-homepage/Yu_Gong_Resume_IC.pdf",
        pagesize=letter,
        topMargin=0.5*inch,
    ...
    story.append(Indenter(left=-INDENT))
    story.append(Paragraph(
        "Led the design and development of AI Search and Shopping Agent systems for TikTok global e-commerce, "
        "supporting ~140M daily e-commerce queries in the U.S. alone.",
        style_body_small
    ))
    ...
    story.append(Paragraph(u"<bullet>\u2022</bullet><b>Agent Framework</b> \u2014 Planner-Executor-Verifier architecture (Harness) with multi-turn context management and heterogeneous tool use (Web / Product / Video Search).", style_bullet))
    story.append(Paragraph(u"<bullet>\u2022</bullet><b>Memory &amp; Personalization</b> \u2014 Memory-as-Tool design: hierarchical memory distilled from long-horizon user behavioral signals; a decoupled MemAgent performs query-aware retrieval and evidence-grounded extraction for personalized decisions.", style_bullet))
    ...
    doc.build(story)
    print("Resume generated: Yu_Gong_Resume_IC.pdf")
